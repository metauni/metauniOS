...
return function(props)
	...
	do
		...
		emojiMenu = UI.RoundedFrame {
			...
			[Fusion.Cleanup] = if props.ReceiveEmojiSignal
				then props.ReceiveEmojiSignal:Connect(function(emojiName: string)
			...
			UI.Div {
				...
				[Children] = {
					...
					Computed(function()
						...
						if
							Players.LocalPlayer.UserId == 2293079954
							or Players.LocalPlayer.UserId == 2211421151 and props.IsSpeaker:get()
						then
							return menuButton {
								Text = "Replay",
